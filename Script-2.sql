...
create view topres151120 as
select 'Angular' as name, sum(val) from jsres151120 j where tag like 'Angular%'
union
select 'React' as name, sum(val) from jsres151120 j where tag like 'React%'
union
select 'Vue' as name, sum(val) from jsres151120 j where tag like 'Vue%'
union
select 'jQuery' as name, sum(val) from jsres151120 j where tag like 'jQuery';

drop view if exists topres040121;
create view topres040121 as
select 'Angular' as name, sum(val) from jsres040121 j where tag like 'Angular%'
union
select 'React' as name, sum(val) from jsres040121 j where tag like 'React%'
union
select 'Vue' as name, sum(val) from jsres040121 j where tag like 'Vue%'
union
select 'jQuery' as name, sum(val) from jsres040121 j where tag like 'jQuery';

select tr1.name, round((tr1.sum/(select max(t1.sum) from topres151120 t1))*100), 
round((tr2.sum/(select max(t1.sum) from topres040121 t1))*100) from topres151120 tr1
left join topres040121 tr2
on tr1.name = tr2.name;

select 'Angular' as name, sum(val) from py040121 j where tag like 'Angular%'
union
select 'React' as name, sum(val) from py040121 j where tag like 'React%'
union
select 'Vue' as name, sum(val) from py040121 j where tag like 'Vue%'
union
select 'jQuery' as name, sum(val) from py040121 j where tag like 'jQuery';

select 'Angular' as name, sum(val) from py151120 j where tag like 'Angular%'
union
select 'React' as name, sum(val) from py151120 j where tag like 'React%'
union
select 'Vue' as name, sum(val) from py151120 j where tag like 'Vue%'
union
select 'jQuery' as name, sum(val) from py151120 j where tag like 'jQuery';

select 'React' as name, sum(count) from django2021 d where d.tag like 'React%'
union
select 'Vue' as name, sum(count) from django2021 d2 where d2.tag like 'Vue%'
union 
select 'Angular' as name, sum(count) from django2021 d3 where d3.tag like 'Angular%'
union 
select 'jQuery' as name, sum(count) from django2021 d4 where d4.tag like 'jQuery';

select * from django2021;

create table intern180321 (id serial, tag varchar, val float);
select * from intern180321 where tag similar to '[A-z\s]*';
select * from intern180321 where tag similar to '%Битрикс' 
or tag similar to 'Django%'
or tag similar to 'Vue%'
or tag similar to 'Angular%'
or tag similar to 'React%'
or tag similar to 'jQuery';